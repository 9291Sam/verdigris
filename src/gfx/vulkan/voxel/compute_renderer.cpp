...
//                   | vk::ImageUsageFlagBits::eStorage, //  It's similar to
//                   trying to save a screenshot, look at Sascha's example on
//                   that.
...
//         , foo {0}
//         , is_first_pass {true}
//         // TODO: actually make the buffers sparse and reallocating
//         (vkCmdCopyBuffer) , volume {this->device, this->allocator, 512} //!
//         sync with shader!
//     {
//         util::logLog(
...
//         static constexpr std::array<gfx::recordables::FlatRecordable::Vertex,
//         8> Vertices {
...
//         static constexpr std::array<gfx::recordables::FlatRecordable::Index,
//         36> Indices {
...
//                     std::uniform_int_distribution<std::size_t> distI {1,
//                     5383};
...
//             util::ceilingDivide(x,
//             ComputeRenderer::ShaderDispatchSize.width),
//             util::ceilingDivide(y,
//             ComputeRenderer::ShaderDispatchSize.height), 1);
